drop policy "Usuarios autenticados_Insert" on "public"."rl_proveedor_estacion";

drop policy "Usuarios autenticados_Select" on "public"."rl_proveedor_estacion";

drop policy "Usuarios autenticados_Update" on "public"."rl_proveedor_estacion";

drop policy "Usuarios autenticados_Select" on "public"."ms_conductores";

revoke delete on table "public"."rl_proveedor_estacion" from "anon";

revoke insert on table "public"."rl_proveedor_estacion" from "anon";

revoke references on table "public"."rl_proveedor_estacion" from "anon";

revoke select on table "public"."rl_proveedor_estacion" from "anon";

revoke trigger on table "public"."rl_proveedor_estacion" from "anon";

revoke truncate on table "public"."rl_proveedor_estacion" from "anon";

revoke update on table "public"."rl_proveedor_estacion" from "anon";

revoke delete on table "public"."rl_proveedor_estacion" from "authenticated";

revoke insert on table "public"."rl_proveedor_estacion" from "authenticated";

revoke references on table "public"."rl_proveedor_estacion" from "authenticated";

revoke select on table "public"."rl_proveedor_estacion" from "authenticated";

revoke trigger on table "public"."rl_proveedor_estacion" from "authenticated";

revoke truncate on table "public"."rl_proveedor_estacion" from "authenticated";

revoke update on table "public"."rl_proveedor_estacion" from "authenticated";

revoke delete on table "public"."rl_proveedor_estacion" from "service_role";

revoke insert on table "public"."rl_proveedor_estacion" from "service_role";

revoke references on table "public"."rl_proveedor_estacion" from "service_role";

revoke select on table "public"."rl_proveedor_estacion" from "service_role";

revoke trigger on table "public"."rl_proveedor_estacion" from "service_role";

revoke truncate on table "public"."rl_proveedor_estacion" from "service_role";

revoke update on table "public"."rl_proveedor_estacion" from "service_role";
...
alter table "public"."rl_proveedor_estacion" drop constraint "rl_proveedor_estacion_id_estacion_fkey";

alter table "public"."rl_proveedor_estacion" drop constraint "rl_proveedor_estacion_pkey";

drop index if exists "public"."rl_proveedor_estacion_pkey";

drop table "public"."rl_proveedor_estacion";
